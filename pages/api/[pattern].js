export default function handler(req, res) {
  ...
  if (!match) {
    ...
    res.status(400).send(`
      ...
      <html lang="en">
        ...
        <body>
          <h1>Please use the correct dice roll format (e.g., /xdy+z or /dy+z).</h1>
        </body>
      </html>
    `);
    return;
  ...
  const z = match[3] ? parseFloat(match[3]) : 0;  // Default to 0 if z is not provided, ensure it's a float
